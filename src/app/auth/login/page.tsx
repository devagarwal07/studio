...
export default function LoginPage() {
  ...
  const handleLogin = async (event: React.FormEvent) => {
    ...
    // Store intended role before attempting sign-in
    ...
    try {
      ...
      toast({
        ...
        description: `Attempting to log in as ${selectedRole}...`,
      });
      // Redirection is handled by AuthProvider based on stored role and verification
    } catch (error: any) {
      console.error("Login failed:", error);
      sessionStorage.removeItem('intendedRole'); // Clear role on failure
      toast({
        title: "Login Failed",
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      toast({
        title: "Login Successful",
        description: `Attempting to log in with Google as ${selectedRole}...`,
      });
       // Redirection is handled by AuthProvider based on stored role and verification
    } catch (error: any) {
